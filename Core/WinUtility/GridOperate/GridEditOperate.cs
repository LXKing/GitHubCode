...
namespace XCI.WinUtility
{
    ...
    public class GridEditOperate<E, S>
        ...
        where S : class,IEntityService<E>
    {
        ...
        protected E SelectedEntityCopy
        {
            get
            {
                if (Grid != null && Grid.DataSource != null)
                {
                    ...
                    {
                        var entity = Grid.GetSelected<DataRow>();
                        if (entity != null)
                        {
                            var copyRow = DataTableHelper.CopyDataRow(entity);
        ...
        /// 保存后选中记录
        /// </summary>
        protected virtual bool IsSaveSelectRecord
        {
            get { return true; }
        }
        ...
        /// 数据绑定事件
        /// </summary>
        public event EventHandler<BindEventArgs> BeforeBind;

        /// <summary>
        /// 触发数据绑定
        /// </summary>
        /// <param name="e">绑定事件参数</param>
        protected void OnBeforeBind(BindEventArgs e)
        {
            if (BeforeBind != null)
            {
                BeforeBind(this, e);
        ...
        /// 数据绑定后事件
        /// </summary>
        public event EventHandler<BindEventArgs> AfterBind;
        ...
        {
            Func<bool> validateFun = () => control.Text.Trim().Length > 0;
        ...
        {
            if (Grid == null) return;
            if (MoveFirstButton != null) MoveFirstButton.Enabled = !Grid.IsFirstRow;
            if (MovePreviousButton != null) MovePreviousButton.Enabled = !Grid.IsFirstRow;
            if (MoveNextButton != null) MoveNextButton.Enabled = !Grid.IsLastRow;
            if (MoveLastButton != null) MoveLastButton.Enabled = !Grid.IsLastRow;
        ...
        /// 通知控件值发生改变
        /// </summary>
        public void EditValueChangedNotifyAction()
        {
