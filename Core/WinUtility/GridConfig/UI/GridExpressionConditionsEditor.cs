...
{
    public partial class GridExpressionConditionsEditor : UserControlBase
    {
        /// <summary>
        /// 目标表格
        /// </summary>
        ...
        public GridExpressionConditionsEditor()
        {
            InitializeComponent();
        ...
        {
            Grid.DataSource = TargetGrid.View.FormatConditions;
        }

        protected void LoadGridColumn()
        {
            foreach(GridColumn col in TargetGrid.View.Columns)
            {
