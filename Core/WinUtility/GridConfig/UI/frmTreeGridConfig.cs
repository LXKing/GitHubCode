...
{
    public partial class frmTreeGridConfig : FormBase
    {
        #region 属性
        ...
        public frmTreeGridConfig(XCITreeGrid grid)
        {
            InitializeComponent();
        ...
        protected virtual void PageLoadAction(string name)
        {
            ...
            {
                case "pageGeneral":
                    treeGeneralEditor1.Initialize(grid, grid);
                    break;
                case "pageGridColumn":
                    treeColumnEditor1.Initialize(grid);
                    break;
                case "pageAppearance":
                    gridAppearanceEditor1.Initialize(grid.Appearance);
                    break;
                case "pageGridStyle":
                    treeExpressionConditionsEditor1.Initialize(grid);
                    break;
                case "pageAdvanced":
                    gridAdvancedEditor1.Initialize(grid, grid);
                    break;
                case "pageTemplate":
