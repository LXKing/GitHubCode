...
//    public class XtraSchedulerExtensions_zhchs : SchedulerExtensionsResLocalizer
//    {
...
//                case SchedulerExtensionsStringId.Msg_AppointmentOccurs:
//                    return "发生 {0}.\r\n";

//                case SchedulerExtensionsStringId.Msg_AppointmentOccursInThePast:
//                    return "预约出现在过去";

//                case SchedulerExtensionsStringId.Msg_AllOccurrencesInThePast:
//                    return "发生在过去的所有重复预约的实例.";

//                case SchedulerExtensionsStringId.Msg_AppointmentConflictsWithAnother:
//                    return "与其他在您计划中的预约冲突.";

//                case SchedulerExtensionsStringId.Msg_PatternOccurrencesConflictsWithOtherAppointments:
