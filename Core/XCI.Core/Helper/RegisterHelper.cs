    ...
    public class RegisterHelper
    {
        ...
        public virtual bool IsRegeditKeyExist()
        {
            ...
            if (IsSubKeyExist())
            {
                ...
                {
                    if (System.String.Compare(regeditKey, _regeditkey, System.StringComparison.OrdinalIgnoreCase) == 0)
                    {
                        result = true;
                        break;
                    }
        ...
        public virtual bool IsRegeditKeyExist(string name)
        {
            ...
            if (IsSubKeyExist())
            {
                ...
                foreach (string regeditKey in regeditKeyNames)
                {
                    if (System.String.Compare(regeditKey, name, System.StringComparison.OrdinalIgnoreCase) == 0)
                    {
                        result = true;
                        break;
                    }
