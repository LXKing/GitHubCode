...
namespace COMMON.Encryption
{
    ...
    public class Cipher
    {
        ...
        public static string AESEncrypt(string EncryptString, string EncryptKey, CipherMode cipherModem = CipherMode.ECB, PaddingMode paddingMode = PaddingMode.PKCS7)
        {
        ...
        public static string AESDecrypt(string DecryptString, string DecryptKey, CipherMode cipherModem = CipherMode.ECB, PaddingMode paddingMode = PaddingMode.PKCS7)
        {
