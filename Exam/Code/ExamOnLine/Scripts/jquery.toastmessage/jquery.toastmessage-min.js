(function (c) {
    var b = { inEffect: { opacity: "show" }, inEffectDuration: 600, stayTime: 3000, text: "", sticky: false, type: "notice", position: "top-right", closeText: "", close: null };
    var a = {
        init: function (d) {
            if (d) {
                c.extend(b, d)
    ...
    c.fn.showError = function (msg, sticky, closeCallback) {
        if (sticky == undefined)
            sticky = false;
    ...
    c.fn.showWarning = function (msg, sticky,closeCallback) {
        if (sticky == undefined)
            sticky = false;
        $().toastmessage('showToast', {
            text: msg,
    ...
    c.fn.showSuccess = function (msg, sticky, closeCallback) {
        if (sticky == undefined)
            sticky = false;
        $().toastmessage('showToast', {
            text: msg,
    ...
    c.fn.showNotice = function (msg, sticky, closeCallback) {
        if (sticky == undefined)
            sticky = false;
        $().toastmessage('showToast', {
            text: msg,
